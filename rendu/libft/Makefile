...
#    Updated: 2018/11/17 21:32:11 by ezonda           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_atoi.c ./ft_bzero.c ./ft_isalnum.c ./ft_isalpha.c ./ft_isascii.c \
	  ...
	  ./ft_memccpy.c ./ft_memchr.c ./ft_memcmp.c ./ft_memcpy.c ./ft_memcpy.c \
	  ...
	  ./ft_strtrim.c ./ft_tolower.c ./ft_toupper.c ./ft_lstadd.c \
	  ./ft_lstiter.c ./ft_lstmap.c ./ft_lstnew.c ./ft_lstdelone.c \
...
OBJ = ./ft_atoi.o ./ft_bzero.o ./ft_isalnum.o ./ft_isalpha.o ./ft_isascii.o \
	  ...
	  ./ft_memccpy.o ./ft_memchr.o ./ft_memcmp.o ./ft_memcpy.o ./ft_memcpy.o \
	  ...
	  ./ft_strrev.o ./ft_strsplit.o ./ft_strstr.o ./ft_strsub.o \
	  ./ft_strtrim.o ./ft_tolower.o ./ft_toupper.o ./ft_lstadd.o \
	  ./ft_lstiter.o ./ft_lstmap.o ./ft_lstnew.o ./ft_lstdelone.o \
	  ./ft_lstdel.o ./ft_is_prime.o ./ft_recursive_power.o ./ft_sqrt.o \
